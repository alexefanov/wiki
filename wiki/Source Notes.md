...
Краткие заметки по ingested источникам из `raw/`. Файлы `raw/` не изменялись (кроме добавления новых источников пользователем).
...
## Строительство и нормативы

### ГОСТ 31937-2024

- Raw: [raw/Здания и сооружения. Правила обследования и мониторинга технического состояния. ГОСТ 31937-2024 — Редакция от 10.04.2024.md](<../raw/Здания%20и%20сооружения.%20Правила%20обследования%20и%20мониторинга%20технического%20состояния.%20ГОСТ%2031937-2024%20%E2%80%94%20%D0%A0%D0%B5%D0%B4%D0%B0%D0%BA%D1%86%D0%B8%D1%8F%20%D0%BE%D1%82%2010.04.2024.md>)
- URL: https://normativ.kontur.ru/document?moduleId=9&documentId=473287
- Summary: правила обследования и мониторинга технического состояния зданий и сооружений; четыре категории состояния; этапы обследования (подготовка, визуальное, инструментальное); виды мониторинга (общий, ограниченно-работоспособные/аварийные, зона влияния, уникальные); заменяет ГОСТ 31937-2011, действует с 01.05.2024.
- Key terms: [[ГОСТ 31937-2024]], обследование, мониторинг, категория технического состояния, комплексное обследование, поверочный расчёт, специализированная организация.
