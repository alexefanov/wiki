...
description: "Статья на Habr для начинающих о ведении заметок по методу Zettelkasten в Obsidian — как превратить программу заметок во второй мозг и эффективно усваивать новую информацию."
---
